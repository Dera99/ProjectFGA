...
public class Menu extends javax.swing.JPanel {
    ...
    private void addMenu(String menuName, String icon, int index) {
        ...
        m.setIcoName(icon);
        m.setIcon(new ImageIcon(getClass().getResource("/com/app/icon/" + icon + ".png")));
        ...
        for (Component com : menu.getComponents()) {
            if (com instanceof MenuButton) {
                ...
                if (!c.getIcoName().contains("_s")) {
                    c.setIcon(new ImageIcon(getClass().getResource("/com/app/icon/" + c.getIcoName() + ".png")));
                }
            }
        }
    }
    ...
    public void setSelectedMenu(int index) {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/app/icon/" + cmd.getIcoName() + "_s.png")));
    }
    ...
    private void initComponents() {
        ...
        imageAvatar2 = new com.app.theme.ImageAvatar();
        menu = new javax.swing.JPanel();
        jLabel1 = new javax.swing.JLabel();
        jLabel2 = new javax.swing.JLabel();
        imageAvatar = new com.app.theme.ImageAvatar();
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(imageAvatar, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private com.app.theme.ImageAvatar imageAvatar;
    private com.app.theme.ImageAvatar imageAvatar2;
